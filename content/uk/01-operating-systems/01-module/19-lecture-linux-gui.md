...
**X** — віконна система, створена 1984 року в MIT; версія протоколу **X11**, яку використовують дотепер, вийшла 1987 року. Її реалізація для Linux — **Xorg**.
...
**8.** Яке з середовищ не має нативної підтримки Wayland?

- XFCE
- GNOME
- KDE Plasma
- усі три підтримують Wayland нативно
