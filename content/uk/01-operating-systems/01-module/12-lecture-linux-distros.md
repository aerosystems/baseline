...
| Назва | Автор | Рівень |
|-------|-------|--------|
| **RHEL 9 Administration** | Asghar Ghori | Середній |
| **Ubuntu Unleashed** | Matthew Helmke | Початковий-Середній |
| **Arch Linux Handbook** | Dusty Phillips | Середній |
| **Debian Administrator's Handbook** | Hertzog & Mas | Середній |
| **Linux System Administration** | Tom Adelstein | Середній |

### YouTube канали

| Канал | Тематика |
|-------|----------|
| **The Linux Experiment** | Щотижневі огляди дистрибутивів |
| **DistroTube** | Arch, Gentoo, тайлінгові WM |
| **Chris Titus Tech** | Ubuntu, Fedora, gaming на Linux |
| **Veronica Explains** | Enterprise Linux, RHEL |
| **EF - Linux Made Simple** | Порівняння дистрибутивів |
