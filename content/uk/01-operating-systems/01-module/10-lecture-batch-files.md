...
│   │   └── Batch scripts для налаштування нових ПК (принтери, мережа, ПЗ)    │
│   ├── Login scripts через Group Policy:                                     │
│   │   └── Маппінг мережевих дисків, змінних середовища                      │
│   └── Logoff scripts:                                                        │
│       └── Очищення тимчасових файлів, відключення ресурсів                  │
│                                                                              │
│   BACKUP & DISASTER RECOVERY                                                 │
│   ├── Щоденні бекапи:                                                        │
│   │   └── robocopy scripts у Task Scheduler (3:00 AM)                       │
│   ├── Архівація логів:                                                       │
│   │   └── Batch + 7-Zip для компресії та ротації                            │
│   └── Синхронізація з хмарою:                                                │
│       └── Batch wrapper для rclone/azcopy                                   │
│                                                                              │
│   BUILD & DEPLOYMENT                                                         │
│   ├── Legacy CI/CD:                                                          │
│   │   └── build.bat для компіляції C++/Delphi проектів                      │
│   ├── Deployment scripts:                                                    │
│   │   └── Копіювання файлів, перезапуск служб, health checks                │
│   └── Pre/Post deployment hooks:                                             │
│       └── Batch scripts як частина deployment pipeline                      │
│                                                                              │
│   МОНІТОРИНГ ТА ОБСЛУГОВУВАННЯ                                              │
│   ├── Health checks:                                                         │
│   │   └── Періодична перевірка служб та дискового простору                  │
│   ├── Cleanup scripts:                                                       │
│   │   └── Очищення TEMP, кешів браузерів, старих логів                      │
│   └── Restart scripts:                                                       │
│       └── Планові перезавантаження серверів у maintenance window            │
│                                                                              │
│   ІНТЕГРАЦІЯ З LEGACY СИСТЕМАМИ                                             │
│   ├── Виробничі лінії:                                                       │
│   │   └── Batch для комунікації зі старими промисловими системами           │
│   ├── Банківські системи:                                                    │
│   │   └── Batch для обробки щоденних транзакційних файлів                   │
│   └── Державні установи:                                                     │
│       └── Legacy batch scripts, що працюють з 1990-х років                  │
│                                                                              │
└─────────────────────────────────────────────────────────────────────────────┘
```
...
│   ├── Навички: Batch, PowerShell, Group Policy, Task Scheduler             │
│   └── Де потрібно: майже в кожній компанії з Windows інфраструктурою       │
│                                                                              │
│   IT SUPPORT ENGINEER (Level 2/3)                                            │
│   ├── Зарплата: $40,000 - $70,000 USD / €35,000 - €60,000 EUR               │
│   ├── Навички: Scripting для автоматизації типових задач                    │
│   └── Кар'єрний шлях: Support → SysAdmin → DevOps                           │
│                                                                              │
│   BUILD/RELEASE ENGINEER                                                     │
│   ├── Зарплата: $60,000 - $100,000 USD / €55,000 - €90,000 EUR              │
│   ├── Навички: Batch/PowerShell для build automation, CI/CD                │
│   └── Роботодавці: Software companies, game studios                        │
│                                                                              │
│   AUTOMATION ENGINEER                                                        │
│   ├── Зарплата: $70,000 - $120,000 USD / €60,000 - €100,000 EUR             │
│   ├── Навички: Batch, PowerShell, Python, процеси автоматизації            │
│   └── Сектори: Banking, Manufacturing, Logistics                           │
│                                                                              │
│   LEGACY SYSTEMS SPECIALIST                                                  │
│   ├── Зарплата: $80,000 - $130,000 USD / €70,000 - €110,000 EUR             │
│   ├── Навички: Batch, COBOL, mainframe integration                         │
│   └── Попит: Високий у банках та страхових компаніях                        │
│                                                                              │
└─────────────────────────────────────────────────────────────────────────────┘
```
...
| Назва | Автор | Рівень |
|-------|-------|--------|
| Windows Command Line Administration Instant Reference | John Paul Mueller | Початковий |
| Windows Batch Scripting | Udemy/Pluralsight courses | Початковий |
| Windows Administration Resource Kit | Microsoft Press | Середній |
| Mastering Windows Server Scripting | Adam Bertram | Середній |
| Professional Windows PowerShell (includes batch) | Andrew Watt | Просунутий |

### YouTube канали

| Канал | Тематика |
|-------|----------|
| Professor Saad | Batch scripting basics та tutorials |
| ThioJoe | Windows tips включаючи batch |
| NetworkChuck | IT automation включаючи scripting |
| tutorialspoint | Batch programming tutorials |
| LearnCode.academy | Command line та scripting |
...
│   │ pause                        :: Пауза ("Press any key")             │   │
│   │ timeout /t 5                 :: Затримка 5 секунд                   │   │
