...
**Обладнання:** ПК з компілятором або інтерпретатором мови програмування за вибором студента; Середовище розробки (Visual Studio, VS Code або інше); Доступ до Інтернету для перевірки TOTP.
